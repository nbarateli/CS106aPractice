...
/* * File: UfoGame.java * ------------------ * This program plays a game where the user tries to * shoot a UFO before the UFO "lands". */ import acm.program.*;
import acm.graphics.*;
import java.awt.*;
...
public class UfoGame extends GraphicsProgram {
	...
	/**
	 * moves UFO, if UFO has moved to edge of screen, moves * UFO down and
	 * changes UFO direction.
	 */
	...
	/**
	 * checks to see if UFO and bullet collide, if so * bullet and UFO are
	 * removed and both variables are * set to null.
	 */
	...
	/**
	 * determines if bullet has moved of screen, * if it has, removes bullet,
	...
	/* private instance variables */ private GRect ufo;
